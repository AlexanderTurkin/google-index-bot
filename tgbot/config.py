...
class TgBot:
    ...
    def from_env(env: Env):
        ...
        sub_channel = env.str("SUB_CHANNEL")
        admin_channel = env.str("ADMIN_CHANNEL")
        admin_ids = list(map(int, env.list("ADMINS")))
        use_redis = env.bool("USE_REDIS")
        return TgBot(token=token, admin_ids=admin_ids, payment_token=payment_token, sub_channel=sub_channel, admin_channel=admin_channel, use_redis=use_redis)
